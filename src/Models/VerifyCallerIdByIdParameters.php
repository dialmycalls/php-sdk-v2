...
/**
 * VerifyCallerIdByIdParameters Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     DialMyCalls
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class VerifyCallerIdByIdParameters implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'VerifyCallerIdByIdParameters';
    ...
    /**
     * Sets pin
     * @param string $pin (Required)  Verification PIN number received from making add caller ID request.
     * @return $this
     */
