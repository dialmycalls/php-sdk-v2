 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class Shortcode implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'Shortcode';
    ...
    /**
     * Sets id
     * @param string $id Unique identifier for this shortcode.
     * @return $this
     */
