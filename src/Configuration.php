...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.dialmycalls.com/2.0';
    ...
    {
        $report  = 'PHP SDK (DialMyCalls) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . phpversion() . PHP_EOL;
        $report .= '    OpenAPI Spec Version: 2.0.2' . PHP_EOL;
